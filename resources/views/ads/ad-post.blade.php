...
@section('content')
    ...
    <section class="adpost-part">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <form class="adpost-form" id="place-ads-form" action="{{ route('ads.stepOne') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="adpost-card">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="category" class="form-control custom-select" required>
                                            <option value="" disabled selected>{{ __('lang.select_a_category') }}
                                            </option>
                                            @foreach ($categories as $category)
                                                @if ($category->subcategories->count() > 0)
                                                    <optgroup
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="tel" class="form-control d-none" name="phone_no" id="phone_no"
                                        placeholder="{{ __('lang.phone number') }}" autocomplete="off">
                                    <input type="tel" class="form-control mt-15" name="phone_no" id="phone_no"
                                        placeholder="{{ __('lang.phone number') }}" autocomplete="off" required>
                                </div>
                                <div class="form-group">
