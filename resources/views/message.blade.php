                            ...
                            <ul class="inbox-chat-list">
                                <li class="inbox-chat-item">
                                    ...
                                    <div class="inbox-chat-content">
                                        ...
                                        <div class="inbox-chat-text">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis dolorum tempora consequatur. Deleniti nisi libero!</p>
                                            <div class="inbox-chat-action">
                                                <a href="#" title="Remove" class="fas fa-trash-alt"></a>
                                                <a href="#" title="Forward" class="fas fa-forward"></a>
                                            </div>
                                ...
                                <li class="inbox-chat-item my-chat">
                                    ...
                                    <div class="inbox-chat-content">
                                        <div class="inbox-chat-text">
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo dolore animi dolores autem assumenda fuga consequuntur, laboriosam laborum minus provident error officia quasi atque deleniti.</p>
                                            <div class="inbox-chat-action">
                                                <a href="#" title="Remove" class="fas fa-trash-alt"></a>
                                                <a href="#" title="Forward" class="fas fa-forward"></a>
                                            </div>
                                ...
                                <li class="inbox-chat-item my-chat">
                                    ...
                                    <div class="inbox-chat-content">
                                        <div class="inbox-chat-text">
                                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo dolore animi dolores autem assumenda fuga consequuntur</p>
                                            <div class="inbox-chat-action">
                                                <a href="#" title="Remove" class="fas fa-trash-alt"></a>
                                                <a href="#" title="Forward" class="fas fa-forward"></a>
                                            </div>
