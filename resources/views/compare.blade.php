...
<html lang="en" dir="rtl">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Compare List - Classicads</title>
                        ...
                        <div class="table-scroll">
                            <table class="table-list">
                                ...
                                <tbody class="table-body">
                                    <tr>
                                        <td class="table-number"><h6>01</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                        <td class="table-condition"><h6 class="badge use">used</h6></td>
                                        <td class="table-price"><h5>$248</h5></td>
                                        <td class="table-type"><h6>negotiable</h6></td>
                                        <td class="table-status"><h6 class="badge runs">running</h6></td>
                                        <td class="table-action">
                                            <a href="ad-details-left.html" title="View Details" class="icon fas fa-eye"></a>
                                            <button type="button" title="Ad Bookmark" class="icon wish fas fa-heart"></button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-number"><h6>02</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                        <td class="table-condition"><h6 class="badge new">new</h6></td>
                                        <td class="table-price"><h5>$567</h5></td>
                                        <td class="table-type"><h6>fixed</h6></td>
                                        <td class="table-status"><h6 class="badge clos">close</h6></td>
                                        <td class="table-action">
                                            <a href="ad-details-left.html" title="View Details" class="icon fas fa-eye"></a>
                                            <button type="button" title="Ad Bookmark" class="icon wish fas fa-heart"></button>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="table-number"><h6>03</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                    ...
                                    <tr>
                                        <td class="table-number"><h6>04</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                    ...
                                    <tr>
                                        <td class="table-number"><h6>05</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                        <td class="table-condition"><h6 class="badge use">used</h6></td>
                                        <td class="table-price"><h5>$789</h5></td>
                                        <td class="table-type"><h6>negotiable</h6></td>
                                        <td class="table-status"><h6 class="badge runs">running</h6></td>
                                        <td class="table-action">
                                            <a href="ad-details-left.html" title="View Details" class="icon fas fa-eye"></a>
                                    ...
                                    <tr>
                                        <td class="table-number"><h6>06</h6></td>
                                        <td class="table-product">
                                            <img src="images/product/02.jpg" alt="product-1">
                                        </td>
                                        <td class="table-category"><h6><a href="#">Shoes</a></h6></td>
                                        <td class="table-condition"><h6 class="badge new">new</h6></td>
                                        <td class="table-price"><h5>$344</h5></td>
                                        <td class="table-type"><h6>fixed</h6></td>
                                        <td class="table-status"><h6 class="badge clos">close</h6></td>
                                        <td class="table-action">
                                            <a href="ad-details-left.html" title="View Details" class="icon fas fa-eye"></a>
