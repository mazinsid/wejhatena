...
<html lang="en" dir="rtl">
    <head>
        ...
        <!-- FOR WEBPAGE TITLE -->
        <title>Category List - Classicads</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="images/category/hospitality.jpg" alt="category">
                                <a href="#" class="category-content">
                                    <h4>hospitality</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="images/category/agriculture.jpg" alt="category">
                                <a href="#" class="category-content">
                                    <h4>agriculture</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="images/category/bussiness.jpg" alt="category">
                                <a href="#" class="category-content">
                                    <h4>bussiness</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="images/category/education.jpg" alt="category">
                                <a href="#" class="category-content">
                                    <h4>education</h4>
                                    <p>(3678)</p>
                                </a>
